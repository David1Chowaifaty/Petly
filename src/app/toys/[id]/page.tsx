    ...
    <main className="h-full p-6 space-y-10">
      ...
      <div className="grid gap-6 md:grid-cols-2 md:gap-10 items-center lg:gap-14">
        ...
        <div className="h-full flex flex-col gap-4 justify-around">
          ...
          <StarsRating productId={id} userId="" category="toys" />
          {toy!.quantity > 0 && (
      ...
      <h1 className="title">What others thought of this product</h1>
      <textarea
        placeholder="message"
        className="w-full border-b px-4 py-1.5 h-11 focus:outline-none "
      /> */}
    </main>
  );
}
